...
const EMAIL_ICON =
	'<svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M14.95 3.684L8.637 8.912a1 1 0 0 1-1.276 0l-6.31-5.228A.999.999 0 0 0 1 4v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a.999.999 0 0 0-.05-.316M2 2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2m-.21 1l5.576 4.603a1 1 0 0 0 1.27.003L14.268 3z"/></svg>';
const LOCATION_ICON =
...
// React.js at home:
const MarkerSvg = ({ lat, lng, name, flag, type, phone, email, location }) => `
<button class="infoButton" data-name="${name}">
	...
	<div class="infoButton-container" style="background-color: #f2f5f8">
		<div class="infoButton-container-message" style="display: flex; flex-direction: column; gap: 10px; color: ${SELECTED_COLOR}">
			...
			<div style="display: flex; flex-direction: column; gap: 5px">
				...
				<span style="display: flex; gap: 5px; align-items: center">
					<span style="stroke: ${RED_COLOR}; fill: ${RED_COLOR};">${EMAIL_ICON}</span>
					<span>${email}</span>
				</span>
				<span style="display: flex; gap: 5px; align-items: center">
...
const cords = [
	{
		...
		info: {
			...
			location: "New York, United States of America 🦅🛢️💣",
		},
	},
	{
		lat: 34.88902,
	...
	world
		...
		.htmlElement((d) => {
			...
			el.onclick = () => {
				...
				const isActive = el.classList.contains("infoButton_isActive");
...
const mapButtons = () => {
	...
	btn.forEach((element) => {
		element.addEventListener("click", (e) => {
			...
			// 	`path[data-lat='${temp.lat}'], path[data-lng='${temp.lng}']`
			// );
			...
			// document.querySelectorAll("#animate").forEach((btn) => {
			// 	btn.parentElement.parentElement.classList.remove("infoButton_isActive");
			// });

			// if (isActive) {
			// 	selectedElement.parentElement.parentElement.classList.remove(
			// 		"infoButton_isActive"
			// 	);
			// } else {
			// 	selectedElement.parentElement.parentElement.classList.add(
			// 		"infoButton_isActive"
			// 	);
			// }
